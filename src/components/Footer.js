      ...
      <section className="">
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 border-end border-2">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 border-end border-2">
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mb-4">
              <div className="justify-content-center" style={{ widht: "50%" }}>
                <h6 className="text-uppercase fw-bold mb-3 border-bottom border-2">
                  <i className="fas fa-gem "></i>Newsletter SignUp
                </h6>

                <div className="col-md-5 col-12 ">
                  <div className="form-outline form-white mb-4 d-flex" style={{width:'20vw'}}>
                    <TextField
                      id="outlined-basic"
                      ...
                      style={{ width: "12vw" }}
                    />
                    <Button variant="outlined" size="medium">Join</Button>
                  </div>
                </div>
                <h6 className="text-uppercase fw-bold mb-3 border-bottom border-2">
