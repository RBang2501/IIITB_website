...
export const SocialMediaEmbed = () => {
    return (
        <>
            <div className='d-flex justify-content-around my-5 mx-auto' style={{ width: '96%' }}>
                ...
                <div className='col-'>
                    ...
                    <div className='insta-container my-0 py-0' style={{ display: 'flex' }}>
                        <InstagramEmbed className='instaEmbed shadow-lg' captioned="false" url="https://www.instagram.com/p/CoZiWXuyYXR/?utm_source=ig_web_copy_link" width={328} />
                    ...
                    <div className='insta-container my-0 py-0' style={{ display: 'flex', transform: 'translateY(-55px)' }}>
                        <InstagramEmbed className='instaEmbed shadow-lg' captioned="false" url="https://www.instagram.com/p/CocPkCqvZhp/?utm_source=ig_web_copy_link" width={328} />
                ...
                <div className='col-5'>
                    <h5 className='text-center mb-0 pb-0 fw-bold' style={{ fontFamily: 'sans-serif' }}><LinkedIn className='mb-1' style={{ fontSize: '30px' }} /> Linkedin</h5>
                    <div className='shadow' style={{ height: '650px', overflow: 'scroll' }}>
                        ...
                        <h5 className='text-center mb-0 pb-0 fw-bold' style={{ fontFamily: 'kanit' }}><YouTube className='mb-1' style={{ fontSize: '30px' }} /> IITB Campus Tour</h5>
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                            <YouTubeEmbed className="border border-dark border-3" url="https://youtu.be/eln9l9SxKyo" width="100%" height={280} />
                        </div>
                    </div>
                </div>

                <div className='col-3'>
                    <h5 className='mb-0 pb-0' style={{ fontFamily: 'monospace' }}><Twitter className='mb-1' style={{ fontSize: '30px' }} /> @IIITB_official</h5>
                    <div className='shadow-lg' style={{ height: '650px', overflow: 'scroll' }}>
                        <TwitterEmbed
